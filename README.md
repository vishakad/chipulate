...
## Running ANIMATE
	...
	genomic location.  
	<binding_energy_A> --- Binding energies of TF A at each location, which is the
	...
	<binding_energy_B> --- Binding energies of TF B at each location. This is only
	...
	"direct" or "indirect". 
	<interaction_energy>--- When binding energies for A and B are supplied, the
